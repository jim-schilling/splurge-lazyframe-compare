...
def demonstrate_comparator():
    """Demonstrate using the LazyFrameComparator."""
    print("\n\n" + "=" * 60)
    print("DEMONSTRATING LAZYFRAME COMPARATOR")
    print("=" * 60)
...
def main():
    ...
    print("This example shows the modular, service-oriented design")
    ...
    print("=" * 60)
    print("\nKey Benefits of the Service Architecture:")
